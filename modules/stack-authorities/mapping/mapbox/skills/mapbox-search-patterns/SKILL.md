...
- User needs to choose between search_and_geocode_tool vs category_search_tool vs reverse_geocode_tool
- User asks "Which search API should I use?"
- User needs parameter guidance (proximity, bbox, types, etc.)
- User asks about search tool capabilities and limits

**Not for:**

- Full search implementation workflow (use mapbox-search-integration instead)
- UI components for search (use mapbox-web-integration-patterns + web.react-critic)
- MCP bulk operations (use mapbox-mcp-devkit-patterns)
- Studio dataset creation (use mapbox-standards)

**See also:**

- mapbox-search-integration - Complete search implementation workflow
- mapbox-mcp-devkit-patterns - MCP DevKit Server tools
