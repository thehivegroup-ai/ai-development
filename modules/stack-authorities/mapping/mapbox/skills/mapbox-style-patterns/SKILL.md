...
- User needs style recipes for specific use cases (restaurant finder, real estate, etc.)
- User asks "How do I style X type of map?"
- User needs layer configuration examples
- User wants proven patterns for common scenarios

**Not for:**

- Style validation or optimization (use mapbox-style-quality)
- Framework integration (use mapbox-web-integration-patterns)
...
- mapbox-data-visualization-patterns - Choropleth, heatmaps, 3D
