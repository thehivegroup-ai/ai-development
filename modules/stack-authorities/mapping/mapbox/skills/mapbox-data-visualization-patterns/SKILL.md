...
- Style recipes for general use cases (use mapbox-style-patterns)
...
- mapbox-style-patterns - General style recipes and layer configurations
...
const visibleData = allData.features.filter((feature) =>
  isFeatureInBounds(feature, bounds),
);
