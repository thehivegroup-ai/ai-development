...
- `teleological-planning` - Outcome-driven planning for frontend work
- Stack-specific skills (when installed via MCP) - Framework conventions for your project
...
- `docs/architecture/` - Project-specific frontend patterns and decisions
