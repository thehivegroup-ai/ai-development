...
version: 1.0.0
description: >
  Evaluate UI design quality using Nielsen's heuristics and core visual design principles, 
  operationalized as a repeatable review system for web and mobile. Use when evaluating UI 
  usability, reviewing screen designs, or when a design feels off and needs structured critique.
  
  Trigger when user mentions: design review, UI evaluation, usability issues, design critique, 
  heuristic evaluation, Nielsen's heuristics, check design quality, accessibility review, 
  design feels wrong, user experience problems, or asks "is this design good" or "what's wrong 
  with this UI."
---
...
**For comprehensive UI evaluations**, launch `ux-heuristic-evaluator` subagent:

```
"Evaluate [screen/flow name] against Nielsen's heuristics and visual design principles"
```

**Token savings:** 50-70K tokens  
**Time savings:** 40-60% faster (parallel evaluation dimensions)

**When to use subagent:**
- ✅ Full application UI audit (multiple screens)
- ✅ Complete design system evaluation
- ✅ Pre-launch comprehensive review

**When to keep in main conversation:**
- ❌ Single component quick check
- ❌ Specific heuristic validation
- ❌ Minor design tweak review

## Parallel Execution Strategy

**Phase 1: Evaluation Dimensions (PARALLEL)**
```
┌──────────────────────────────────────────────┐
│ Task A: Usability Heuristics                 │
│         - ux-heuristic-evaluator subagent    │
│         - Score 10 heuristics                │
│                                              │
│ Task B: Visual Design Principles             │
│         - ux-visual-design-critic subagent   │
│         - Score 11 principles                │
│                                              │
│ Task C: Platform Compliance                  │
│         - ux-platform-evaluator subagent     │
│         - Check HIG/Material Design          │
│                                              │
│ Task D: Accessibility Check                  │
│         - ux-accessibility-auditor subagent  │
│         - Validate WCAG criteria             │
└──────────────────┬───────────────────────────┘
                   ↓
Phase 2: Synthesis (SEQUENTIAL)
• Compile findings from all dimensions
• Classify severity (Nielsen scale)
• Prioritize by impact/frequency
                   ↓
Phase 3: Validation (PARALLEL)
┌──────────────────────────────────────────────┐
│ Task A: Feasibility Check                    │
│         - std-planner subagent               │
│                                              │
│ Task B: Consistency Check                    │
...
**Time savings:** 50-70% faster than sequential
